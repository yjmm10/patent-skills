...
- **可自修**（ typo、过渡、句式）：静默修订后再交付
- **需作者决策**（缺实验、矛盾数据）：在变更摘要中 **⚠️ 待作者确认** 列出

## 交付前最终输出给用户

- 润色正文（或文件路径）
- 变更摘要
- 检查清单**得分摘要**（通过 N / 待改进 N / 严重 N）
- 若有 P0 待确认项，单独列出

## 禁止

- 正文不出现「Step 4」「自检清单」标题
- 不因自检再次大幅重写已确认章节（iteration 除外）
